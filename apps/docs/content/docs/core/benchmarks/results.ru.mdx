...
description: "Бенчмарки и метрики производительности @ambrosia-unce/core"
---
...
- @ambrosia-unce/core: ~-10-30% (зависит от нагрузки)

## Сравнение с конкурентами

| DI Library | Ops/sec (simple) | Bundle size | Runtime |
|------------|------------------|-------------|---------|
| @ambrosia-unce/core | 867,814 | 36.79 KB | Bun |
...
@ambrosia-unce/core обеспечивает высокую производительность благодаря:
