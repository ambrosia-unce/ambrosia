---
title: "Типы ошибок"
description: "Справочник по всем ошибкам DI-контейнера @ambrosia/core"
---
...
```typescript
import { ProviderNotFoundError } from "@ambrosia/core";
...
```typescript
import { ResolutionError } from "@ambrosia/core";
...
```typescript
import { NoRequestScopeError } from "@ambrosia/core";
