...
@ambrosia-unce/core supports async operations for cases where instance creation requires asynchronous initialization - connecting to a database, loading configuration, verifying external services.
