...
description: "Изучите общие паттерны и лучшие практики использования @ambrosia-unce/core"
---
...
Освойте фундаментальные паттерны использования @ambrosia-unce/core в ваших приложениях.
