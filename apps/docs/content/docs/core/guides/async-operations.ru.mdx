...
@ambrosia/core поддерживает асинхронные операции для случаев, когда создание экземпляра требует асинхронной инициализации — подключение к БД, загрузка конфигурации, проверка внешних сервисов.
