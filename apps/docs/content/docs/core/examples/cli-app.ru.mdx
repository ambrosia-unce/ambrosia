...
description: "Пример использования @ambrosia-unce/core в консольном приложении с паттерном Command"
---
...
import { Injectable, Scope, Implements } from "@ambrosia-unce/core";
