...
description: "Поймите фундаментальные принципы dependency injection и @ambrosia/core"
---
...
Изучите фундаментальные концепции dependency injection и как @ambrosia/core их реализует.
...
**Container** — это сердце @ambrosia/core. Он управляет:
...
Провайдеры определяют, как контейнер создаёт экземпляры. В @ambrosia/core есть **4 типа** провайдеров:
...
Токены однозначно идентифицируют зависимости. В @ambrosia/core есть **4 вида** токенов:
