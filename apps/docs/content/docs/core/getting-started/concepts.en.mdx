---
title: "Core Concepts"
description: "Understand the fundamental principles of dependency injection and @ambrosia/core"
---
...
Learn the fundamental concepts of dependency injection and how @ambrosia/core implements them.
...
The **Container** is the heart of @ambrosia/core. It manages:
...
Providers define how the container creates instances. @ambrosia/core has **4 types** of providers:
...
Tokens uniquely identify dependencies. @ambrosia/core supports **4 types** of tokens:
